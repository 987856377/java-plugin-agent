...
package org.apache.agent.plugin.logging.base.definition;
...
public final class BaseLoggingPluginDefinitionService extends AbstractPluginDefinitionService {
    ...
    private static final String SCHEMA_METADATA_LOADER_CLASS = "com.spring.web.metadata.MetaDataContextsFactory";

    private static final String SCHEMA_METADATA_LOADER_METHOD_NAME = "create";

    private static final String SCHEMA_METADATA_LOADER_ADVICE_CLASS = "org.apache.agent.plugin.logging.base.advice.MetaDataContextsFactoryAdvice";
