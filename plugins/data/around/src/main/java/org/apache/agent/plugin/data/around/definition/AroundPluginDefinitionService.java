...
package org.apache.agent.plugin.data.around.definition;
 ...
 */
@Slf4j
public final class AroundPluginDefinitionService extends AbstractPluginDefinitionService {

    private static final String METHOD_INSTANCE_TYPE = "instance";
    private static final String METHOD_STATIC_TYPE = "static";

    private static final String DEFAULT_INTERCEPTORS_PATH = "/config/around.yaml";
