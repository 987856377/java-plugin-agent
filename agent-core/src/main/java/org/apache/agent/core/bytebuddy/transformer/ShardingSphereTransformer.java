...
package org.apache.agent.core.bytebuddy.transformer;
...
import org.apache.agent.api.api.advice.*;
import org.apache.agent.api.api.point.ClassStaticMethodPoint;
import org.apache.agent.api.api.point.ConstructorPoint;
import org.apache.agent.api.api.point.InstanceMethodPoint;
import org.apache.agent.api.api.point.PluginInterceptorPoint;
import org.apache.agent.core.plugin.PluginLoader;
import org.apache.agent.core.plugin.interceptor.*;
import org.apache.agent.core.plugin.interceptor.compose.*;
...
public final class ShardingSphereTransformer implements Transformer {
    ...
    public Builder<?> transform(final Builder<?> builder, final TypeDescription typeDescription, final ClassLoader classLoader,
                                final JavaModule module, final ProtectionDomain protectionDomain) {
