...
package org.apache.agent.core.config.yaml.swapper;

import lombok.AccessLevel;
import lombok.NoArgsConstructor;
import org.apache.agent.api.config.AgentConfiguration;
import org.apache.agent.api.config.PluginConfiguration;
import org.apache.agent.core.config.yaml.YamlAgentConfiguration;
import org.apache.agent.core.config.yaml.YamlPluginCategoryConfiguration;
import org.apache.agent.core.config.yaml.YamlPluginConfiguration;
...
public final class YamlAgentConfigurationSwapper {
    ...
    public static AgentConfiguration swap(final YamlAgentConfiguration yamlConfig) {
        ...
        if (null != plugins) {
            ...
            configurationMap.putAll(transformPluginConfigurationMap(plugins.getData()));
        }
